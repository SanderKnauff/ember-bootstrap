...
import ModalHeader, { type HeaderSignature } from './bs-modal/header.ts';
import ModalDialog, {
  type DialogSignature,
  type ModalFullscreen,
  type ModalSize,
} from './bs-modal/dialog.ts';
import ModalBody, { type BodySignature } from './bs-modal/body.ts';
import ModalFooter, { type FooterSignature } from './bs-modal/footer.ts';
