...
import BsAccordionItemTitle from './item/title.ts';
import BsAccordionItemBody from './item/body.ts';
...
export default class AccordionItem extends Component<ItemSignature> {
  ...
  get titleComponent(): ComponentLike<TitleSignature> {
    return this.args.titleComponent ?? BsAccordionItemTitle;
  }
  ...
  get bodyComponent(): ComponentLike<BodySignature> {
    return this.args.titleComponent ?? BsAccordionItemBody;
  }
}
